...
\label{pen_sqr}
\end{figure}
ಚಿತ್ರ \ref{program3} ನಲ್ಲಿರುವ ಪ್ರೋಗ್ರಾಮ್ಮನ್ನು ಮತ್ತೆ ಮೂಡಿಸಿ. ಲೇಖನಿಯುಕ್ತ ಆಜ್ಞೆಯನ್ನು ತಂದು ಚಿತ್ರ \ref{pen_sqr}ರ ಎಡಭಾಗದಲ್ಲಿರುವಂತೆ  ಜೋಡಿಸಿ.   ಪ್ರೋಗ್ರಾಂ ಅನ್ನು  ಚಲಾಯಿಸಿ (ವೇದಿಕೆಯ ಮೇಲಿನ ಹಸಿರು ಧ್ವಜವನ್ನು ಒತ್ತಿ).  ಚಿತ್ರ \ref{pen_sqr}ರ ಕೆಳಭಾಗದಲ್ಲಿ ತೋರಿಸಿರುವಂತೆ, ಥಟ್ಟನೆ ಸ್ಪ್ರಯ್ಟ್ ಚೌಕ ಮೂಡಿಸುತ್ತದೆ. ಚಿತ್ರ \ref{pen_sqr}ನ ಬಲಭಾಗದಲ್ಲಿರುವಂತೆ  ಈ ಪ್ರೋಗ್ರಾಂ ಆನ್ನು ಪುಸ್ತಕದಲ್ಲಿ  ಸರಳವಾಗಿ ಬರೆದುಕೊಳ್ಳಬಹುದು.   ಇದರಲ್ಲಿ ಗಮನಿಸಿ, ಸ್ಪ್ರಯ್ಟ್  ತಾನು ಮೊದಲಿದ್ದ ದಿಕ್ಕಿನಲ್ಲಿ ಮುಖ ಮಾಡಿ ನಿಂತಿಲ್ಲ.  ಆದರೆ ಈಗ ಅದ್ದನ್ನು ತಿದ್ದುವುದು ಹೇಗೆ ಎಂದು ನಮಗೆ ತಿಳಿದಿದೆಯಲ್ಲವೇ?
...
ರೇಖೆಯ ಗಾತ್ರವನ್ನು ಸಾಪೇಕ್ಷ ಮೌಲ್ಯವನ್ನು ಉಪಯೋಗಿಸಿ ಬದಲಾಯಿಸ ಬೇಕಾದರೆ,  "ರಷ್ಟಕ್ಕೆ ಲೇಖನಿ ಗಾತ್ರವನ್ನು ಬದಲಾಯಿಸು \_\_"ಎಂಬ ಆಜ್ಞೆಯನ್ನು ಬಳಸಬೇಕು.  ಚಿತ್ರ \ref{pensize} ರ ಎಡಭಾಗದಲ್ಲಿರುವಂತೆ ಪ್ರೋಗ್ರಾಮ್ಮನ್ನು ಮೂಡಿಸಿ.  "ರಷ್ಟಕ್ಕೆ ಲೇಖನಿ ಗಾತ್ರವನ್ನು ಬದಲಾಯಿಸು 5" ಎಂಬ  ಆಜ್ಞೆ ಎರಡು ಬಾರಿ ಬಳಸಿದ್ದೇವೆ.  ಈ ಪ್ರೋಗ್ರಾಮಿನಲ್ಲಿ ಇವು ಏನು ಕೆಲಸ ಮಾಡುತ್ತಿವೆ ಎಂಬುದರ ಬಗ್ಗೆ ಯೋಚಿಸಿ.  ಪ್ರೋಗ್ರಾಂ ಅನ್ನು  ಚಲಾಯಿಸಿ (ವೇದಿಕೆಯ ಮೇಲಿನ ಹಸಿರು ಧ್ವಜವನ್ನು ಒತ್ತಿ).  ಚಿತ್ರ \ref{pensize}ರ ಕೆಳಭಾಗದಲ್ಲಿ ತೋರಿಸಿರುವಂತೆ, ಸ್ಪ್ರಯ್ಟ್ ಸಣ್ಣ-ದಪ್ಪ-ಅತಿ ದಪ್ಪ ದಂತಿರುವ ರೇಖೆಯನ್ನು ಮೂಡಿಸುತ್ತದೆ.  ಚಿತ್ರ \ref{pensize}ನ ಬಲಭಾಗದಲ್ಲಿರುವಂತೆ  ಈ ಪ್ರೋಗ್ರಾಂ ಆನ್ನು ಪುಸ್ತಕದಲ್ಲಿ  ಸರಳವಾಗಿ ಬರೆದುಕೊಳ್ಳಬಹುದು.  

ಈ ಪ್ರೋಗ್ರಾಮಿನಲ್ಲಿ "ರಷ್ಟಕ್ಕೆ ಲೇಖನಿ ಗಾತ್ರವನ್ನು ಬದಲಾಯಿಸು 5" ಎಂಬ ಎರಡನೇ ಬಾರಿಯ  ಆಜ್ಞೆಯಲ್ಲಿ 5 ಅನ್ನು -5 ಆಗಿ ಬದಲಾಯಿಸಿದರೆ ಏನಾಗುತ್ತದೆ? ಈ ಸವಾಲು ಓದುಗರ ಕುತೂಹಲಕ್ಕೆ. 
...
\begin{center}
\begin{tikzpicture}
\node at (0,0)[draw=blue,  rectangle, minimum width = 4cm, minimum height=1.5cm](s1){};
...
\begin{tikzpicture}
\node at (0,0)[draw=blue,  line width = 2pt, rectangle, minimum width = 2.5cm, minimum height=2.5cm](s1){};
\node at (s1.center)[anchor=center, draw=none,  fill=white, rectangle, minimum width = 0.8cm, minimum height=2.6cm](s2){};
\node at (s1.center)[anchor=center, draw=none,  fill=white, rectangle, minimum width = 2.6cm, minimum height=0.8cm](s3){};
...
\begin{figure}[h]
4. ಸ್ಪ್ರಯ್ಟ್ ವಿವಿಧ ಗಾತ್ರದ ರೇಖೆಗಳ ಚೌಕವನ್ನು ಬಿಡಿಸುವಂತೆ ಪ್ರೋಗ್ರಾಂ  ಬರೆಯಿರಿ. 
\begin{center}
\begin{tikzpicture}
...
\begin{figure}[h]
5.ಸ್ಪ್ರಯ್ಟ್ ವಿವಿಧ ಬಣ್ಣದ ರೇಖೆಗಳನ್ನು ಬಿಡಿಸುವಂತೆ ಪ್ರೋಗ್ರಾಂ ಬರೆಯಿರಿ. \begin{center}
\begin{tikzpicture}
\draw[draw=blue, line width=2pt,line cap=round] (0,0)--++(2cm,0) coordinate (a);
...
\end{tikzpicture}
\end{center}
\caption{ಸ್ಪ್ರಯ್ಟ್ ವಿವಿಧ ಬಣ್ಣದ ರೇಖೆಗಳನ್ನು ಬಿಡಿಸುವುದು}
\label{pen_program5}
\end{figure}
